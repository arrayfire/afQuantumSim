...
/**
 * @brief Rotation Y gate: applies a rotation around the y-axis to the given
 * qubit
 *
 */
class RotY : public QGate {
   public:
    RotY(uint32_t target_qubit_, float angle_) noexcept
        : target_qubit{target_qubit_}, angle{angle_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::RotY);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Rotation Z gate: applies a rotation around the z-axis to the given
 * qubit
 *
 */
class RotZ : public QGate {
   public:
    RotZ(uint32_t target_qubit_, float angle_) noexcept
        : target_qubit{target_qubit_}, angle{angle_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::RotZ);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Hadamard gate: applies a Hadamard gate (superposition gate) to the
 * given qubit (Equivalent to transforming the state from the Z-basis states to
 * X-basis states)
 *
 */
class H : public QGate {
   public:
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::Hadamard);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class Phase : public QGate {
   public:
    Phase(uint32_t target_qubit_, float angle_) noexcept
        : target_qubit{target_qubit_}, angle{angle_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::Phase);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class Swap : public QGate {
   public:
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::Swap);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class CX : public QGate {
   public:
    CX(uint32_t control_qubit_, uint32_t target_qubit_)
    noexcept : control_qubit{control_qubit_}, target_qubit{target_qubit_} {}

    std::string to_string() const override;
    bool check(const QCircuit&) const override;
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CX);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class CY : public QGate {
   public:
    CY(uint32_t control_qubit_, uint32_t target_qubit_)
    noexcept : control_qubit{control_qubit_}, target_qubit{target_qubit_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CY);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class CZ : public QGate {
   public:
    CZ(uint32_t control_qubit_, uint32_t target_qubit_)
    noexcept : control_qubit{control_qubit_}, target_qubit{target_qubit_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CZ);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class CH : public QGate {
   public:
    CH(uint32_t control_qubit_, uint32_t target_qubit_)
    noexcept : control_qubit{control_qubit_}, target_qubit{target_qubit_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CHadamard);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Logical XOR gate: Returns the result XOR of two qubits in the target
 * qubit
 *
 */
using Xor = CX;
...
class CPhase : public QGate {
   public:
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CPhase);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Control Swap gate: Swaps the state of two qubits depending on the
 * state of a control qubit
 *
 */
class CSwap : public QGate {
   public:
    CSwap(uint32_t control_qubit_, uint32_t target_qubit_A_,
          uint32_t target_qubit_B_) noexcept
        : control_qubit{control_qubit_}
        , target_qubit_A{target_qubit_A_}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CSwap);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Control Rotation X gate: applies a rotation around the x-axis to the
 * given qubit depending on the state of a control qubit
 *
 */
class CRotX : public QGate {
   public:
    CRotX(uint32_t control_qubit_, uint32_t target_qubit_,
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CRotX);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Control Rotation Y gate: applies a rotation around the y-axis to the
 * given qubit depending on the state of a control qubit
 *
 */
class CRotY : public QGate {
   public:
    CRotY(uint32_t control_qubit_, uint32_t target_qubit_,
          float angle_) noexcept
        : control_qubit{control_qubit_}
        , target_qubit{target_qubit_}
        , angle{angle_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CRotY);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Control Rotation Z gate: applies a rotation around the z-axis to the
 * given qubit depending on the state of a control qubit
 *
 */
class CRotZ : public QGate {
   public:
    CRotZ(uint32_t control_qubit_, uint32_t target_qubit_,
          float angle_) noexcept
        : control_qubit{control_qubit_}
        , target_qubit{target_qubit_}
        , angle{angle_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CRotZ);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
class CCNot : public QGate {
   public:
    CCNot(uint32_t control_qubit_A_, uint32_t control_qubit_B_,
          uint32_t target_qubit_)
        : control_qubit_A{control_qubit_A_}
        , control_qubit_B{control_qubit_B_}
        , target_qubit{target_qubit_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::CCX);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Logical AND gate: Returns the result AND of control two qubits in the
 * target qubit
 *
 */
using And = CCNot;
...
/**
 * @brief Logical OR gate: Returns the result OR of control two qubits in the
 * target qubit
 *
 */
class Or : public QGate {
   public:
    Or(uint32_t control_qubit_A_, uint32_t control_qubit_B_,
       uint32_t target_qubit_) noexcept
        : control_qubit_A{control_qubit_A_}
        , control_qubit_B{control_qubit_B_}
        , target_qubit{target_qubit_} {}
    ...
    QCircuit& operator()(QCircuit&) const override;
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::Or);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Circuit Gate: Allows for the insertion of Quantum Circuits as a custom
 * gate
 *
 */
class Gate : public QGate {
   public:
     ...
     * @param name alias for the gate (empty string leaves the internal circuit
     * visible)
     */
    Gate(const QCircuit& circuit_, uint32_t target_qubit_begin_,
         std::string name = "");
    ...
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::Circuit);
    }
    bool operator==(const QGate& rhs) const noexcept override;
...
/**
 * @brief Control Circuit gate: Allows for the insertion of a controllable
...
class ControlGate : public QGate {
   public:
     ...
     * @param name name alias for the gate (empty string leaves the internal
     * circuit visible)
     */
    ControlGate(const QCircuit& circuit_, uint32_t control_qubit_,
    ...
    std::string to_string() const override { return representation; }
    uint32_t type() const noexcept override {
        return static_cast<uint32_t>(GateTypes::ControlCircuit);
    }
    bool operator==(const QGate& rhs) const noexcept override;
